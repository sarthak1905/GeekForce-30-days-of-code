// Date- 24/01/2021
// Problem Link- https://codeforces.com/problemset/problem/370/B, rated 1300
...
bool checkSubset(std::vector<int> a, std::vector<int> b){
    ...
    vector<int> cut(a.size() + b.size());
    vector<int>::iterator cutEnd;

    cutEnd = set_intersection(a.begin(), a.end(), b.begin(), b.end(), cut.begin());
